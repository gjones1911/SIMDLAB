...
ap-flow-fw: AP-Flow-Main.cpp AP-Flow.h MOA.c MOA.h AP-Flow-FW.cpp
	g++ -O2 -o ap-flow-fw AP-Flow-Main.cpp MOA.c AP-Flow-FW.cpp -lcrypto

ap-flow-simd: AP-Flow-Main.cpp AP-Flow.h MOA.c MOA.h AP-Flow-SIMD.cpp
	g++ -O2 -o ap-flow-simd AP-Flow-Main.cpp MOA.c AP-Flow-SIMD.cpp -lcrypto -msse2

ap-flow-d: AP-Flow-Main.cpp AP-Flow.h MOA.c MOA.h AP-Flow-Dijkstra.cpp
	g++ -O2 -o ap-flow-d AP-Flow-Main.cpp MOA.c AP-Flow-Dijkstra.cpp -lcrypto
...
#tiptst: tipck.cpp The-Tips-Main.cpp The-Tips.h
#	g++ -O2 -msse2 -o tip-fw-bits-packed-SIMD tipck.cpp The-Tips-Main.cpp

tiptst: tipck.cpp The-Tips-Main.cpp The-Tips.h
	g++ -O2 -msse2 -o tiptst tipck.cpp The-Tips-Main.cpp
